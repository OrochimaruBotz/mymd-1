 ...
          let uptime = clockString(_uptime)  
   const ultah = new Date('April 4, 2023 23:59:59')
    ...
    const detek = Math.floor( Kurang % (1000 * 60) / 1000)
        await this.setBio(`☘️ Ultah Dani : ${ohari} Hari ${ojam} Jam ${onet} Menit ${detek} Detik
⏲️ Runtime: ${uptime} | 🛰 Mode: ${global.opts['self'] ? 'Private' : setting.groupOnly ? 'Only Group' : 'Public'} | 💌 Made DaniGanz`).catch(_  
